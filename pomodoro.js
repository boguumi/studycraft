...
// --- Globale Variablen für Pomodoro und Benutzerstatus ---
// WICHTIG: DOM-Element-Zuweisungen erfolgen JETZT im DOMContentLoaded-Block!
// Hier nur DEKLARIEREN.
let zahlFokuszeit;
let fokusPlus;
let fokusMinus;
let zahlSmallBrake;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // NEU: Selektion der Pause/Play-Icons HIER
    ...
    if (resetPomodoro) {
        resetPomodoro.addEventListener("click", () => {
            ...
            // NEUE ZEILEN FÜR RESET (FÜR PAUSE/PLAY FUNKTION)
    ...
    // NEUER EVENT LISTENER FÜR DAS PAUSE/PLAY ICON
    if (pausePlayIcon) {
