...
function resetPomodoroTimer() {
    if (aktuellerTimerZustand === "fokus" && focusedTimeInSecondsThisSession > 0) {
        // In dieser Implementierung wird bei einem Reset während einer Fokus-Session die Zeit nicht gespeichert.
        // Optional könnte man hier saveFocusedTime(focusedTimeInSecondsThisSession) aufrufen,
        // um auch unvollendete Sessions zu protokollieren.
    }
